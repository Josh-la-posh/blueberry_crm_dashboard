...
function UpcomingEvents() {
  return (
    <div className="bg-white font-semibold flex flex-col xl:gap-8 lg:gap-5 md:gap-0 gap-4 h-full lg:py-5 lg:pl-4 lg:pr-0 md:px-1 p-6 md:pt-2 md pb-4">
            ...
            <div className='flex flex-col md:justify-around md:gap-0 gap-[25px] flex-1'>
                {Events.map(event => {
                    return (
                        <div className="flex items-center lg:gap-[50px] md:gap-0 sm:gap-[70px] gap-[90px]" key={event.id}>
