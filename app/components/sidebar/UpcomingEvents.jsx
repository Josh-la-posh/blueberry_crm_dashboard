...
function UpcomingEvents() {
  return (
    <div className="bg-white flex flex-col xl:gap-8 lg:gap-5 md:gap-0 gap-4 h-full lg:p-5 md:px-1 p-6 md:pt-2 md pb-4">
            <div className="font-bold lg:text-[20px] md:text-[14px] lg:mb-0 md:mb-5 mb-0">Upcoming Events</div>
            <div className='flex flex-col md:justify-between md:gap-0 gap-[15px] flex-1'>
                {Events.map(event => {
                    return (
                        <div className="flex justify-between items-center" key={event.id}>
