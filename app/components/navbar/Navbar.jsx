...
function Navbar() {
  return (
    ...
    >
        <div 
            className="flex items-center justify-between gap-3 md:gap-0 mx-auto lg:px-10 md:px-4 sm:px-10 px-2">
                <AiOutlineMenu />
                <div className="flex items-center gap-5 sm:gap-2">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="rounded-full md:h-[35px] h-[25px] md:w-[35px] w-[25px] bg-black"></div>
